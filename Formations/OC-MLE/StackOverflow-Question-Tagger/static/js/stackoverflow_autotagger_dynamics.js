function start_tagging_question(event) {
    ...
    // $("#start-tagging").prop("disabled", true);
    ...
    $.ajax({
        ...
        success: function(data) {
                    parse_tags(data);
                    // $("#start-tagging").prop("disabled", false);
...
function parse_tags(data) {
    ...
    $(".lds-ring").replaceWith('<a href="{{ url_for(\'index\') }}">'+
                               '<button id="reset-question" class="btn waves-effect waves-light">Reset'+
